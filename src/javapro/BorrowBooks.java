...
PreparedStatement ps = null;
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(isbnfield, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{       
         String query = "INSERT INTO BBOOKS(name, surname, id, subject, title, author, bookid, isbn)values(?,?,?,?,?,?,?,?)";
         ...
         ps.setString(6, authorfield.getText());
         ps.setInt(7, Integer.parseInt(bookidfield.getText()));
         ps.setInt(8, Integer.parseInt(isbnfield.getText()));
         ps.executeUpdate();
         String deletequery = "DELETE FROM books WHERE bookid = "+String.valueOf(Integer.parseInt(bookidfield.getText()));
