...
PreparedStatement ps = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modify the book");
        ...
        jLabel5.setText("ID (the book that you are modifiying)");
    ...
    private void modifybuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifybuttonActionPerformed
        ...
        try{       
         String query = "UPDATE books SET subject = ?, title=?, author = ?, isbn = ?  where bookID = ?";
         ...
         ps.executeUpdate();
         String deletequry = "DELETE FROM books WHERE bookID = "+String.valueOf(Integer.parseInt(idfield.getText()));
